...
public class CommonCalculatedData {
	...
	/**
	 * Энтальпия жидкого сплава H<sub>L</sub><sup>0</sup> (КДж/Моль). <br>
	 * Формула 2.1
	 */
	private double enthalpyLiquidAlloyF2p1;

	/**
	 * Энтальпия испарения сплава &Delta;H<sub>кип</sub> (КДж/Моль). <br>
	 * Формула 2.2
	 */
	private double enthalpyVaporizationF2p2;

	/**
	 * Энтальпия пара для сплава H<sub>g</sub> (КДж/Моль). <br>
	 * Формула 2.3
	 */
	private double enthalpyVaporF2p3;

	/**
	 * Давление пара над сплавом P<sup>p</sup> (Па). <br>
	 * Формула 5
	 */
	private double vaporPressureOverAlloyF5;

	/**
	 * Уменьшение массы расплавленного металла за счет испарения &Delta;<i>v</i><sub>m</sub> (гр/сек) <br>
	 * Формула 9
	 */
	...
	/**
	 * {@link #decreaseMoltenMetalDueVaporizationF9}.
	 */
