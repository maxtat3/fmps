...
public class Container {
	...
	public class Stage1 {
		...
		public class Elements {
			...
			public void setAllElements(ArrayList<GeneralElementStage1> list) {
				for (GeneralElementStage1 el : list) {
					if (el.toString().equals(al.toString())) {
						al = (Al)el;
					} else if (el.toString().equals(mn.toString())) {
						mn = (Mn) el;
					}
				}
			}
